...
example() ->
    {ok, Client} = ecoap_client:open(),  % use a random port and default protocol transport parameters
    ...
    case catch ecoap_client:put(Client, "coap://example.com:5683/HelloWorld", <<"some payload">>, 
